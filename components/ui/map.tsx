...
type MarkerPopupProps = {
  /** Popup content */
  children: ReactNode;
  /** Longitude of the popup (passed through to marker) */
  longitude: number;
  /** Latitude of the popup (passed through to marker) */
  latitude: number;
  ...
  onClose?: () => void;
} & Omit<PopupOptions, "className" | "closeButton" | "closeOnClick" | "closeOnMove" | "focusAfterOpen">;
